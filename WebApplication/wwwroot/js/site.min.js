function setHeight(n){n.each(function(n,t){t.style.height=t.scrollHeight+"px"})}function bindDeleteExample(){$("a.delete-example").on("click",function(){return $(this).parents("div.example-case:first").remove(),!1})}function bs_input_file(){$(".input-file").before(function(){if(!$(this).prev().hasClass("input-ghost")){var n=$("<input type='file' name='SourceFile' accept='.cpp' class='input-ghost' style='visibility:hidden; height:0'>");return n.attr("name",$(this).attr("name")),n.change(function(){n.next(n).find("input").val(n.val().split("\\").pop())}),$(this).find("button.btn-choose").click(function(){n.click()}),$(this).find("input").css("cursor","pointer"),$(this).find("input").mousedown(function(){return $(this).parents(".input-file").prev().click(),!1}),n}})}function bindDeleteTest(){$("a.delete-test").on("click",function(){return $(this).parents("div.test-case:first").remove(),!1})}setHeight($("textarea"));$("#add-test").click(function(){return $.ajax({url:this.href,cache:!1,success:function(n){$("#tests").append(n)}}),!1});$("#add-example").click(function(){return $.ajax({url:this.href,cache:!1,success:function(n){$("#examples").append(n)}}),!1});$(document).ready(function(){bindDeleteExample()});$(document).ajaxComplete(function(){bindDeleteExample()});$(document).ready(function(){$("#deletionModal").on("show.bs.modal",function(n){var t=$(n.relatedTarget),i=t.data("id");document.getElementById("hiddenid").value=i})});$(document).ready(function(){$.ajax({url:this.href,cache:!1,success:function(){var i=$(this).data("id"),r=$(this).data("filePath"),n=window.location.pathname,t="/Problem/Result"+n.substring(n.lastIndexOf("/"))+window.location.search;window.location.href=t}})});$(function(){bs_input_file()});$(document).ready(function(){bindDeleteTest()});$(document).ajaxComplete(function(){bindDeleteTest()});
/*!
